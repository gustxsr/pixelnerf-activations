...
class SpatialEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        activations.append(self.latent)
        layer_names.append("latent")
        
        print("Latent Size", self.latent.shape)
        return self.latent, activations, layer_names
